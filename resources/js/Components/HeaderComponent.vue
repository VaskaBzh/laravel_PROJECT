    ...
    <popup-view id="auth">
        ...
        >
            ...
            >
                ...
                <div class="popup__text">
                    Уже есть аккаунт?
                    <span class="main__link"> Войти </span>
                </div>
            </swiper-slide>
        </swiper>
    </popup-view>
...
export default {
    ...
    setup() {
        ...
        const email_verification = () => {
            ...
            // axios
            //     .get(
            //         "https://pool.api.btc.com/v1/account/sub-account/morelist?access_key=sBfOHsJLY6tZdoo4eGxjrGm9wHuzT17UMhDQQn4N&puid=775149"
            //     )
            //     .then((response) => {
